...
# Generated: Wed Dec 30 22:59:36 2020
##################################################
...
class polarcode_complete(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.projectCACHE_polarEnc_b_0 = projectCACHE.polarEnc_b(N, Nbfiles, NbChuncks, NbStrgUsers, [1,2,3,4], small_packet_len, "packet_len")
