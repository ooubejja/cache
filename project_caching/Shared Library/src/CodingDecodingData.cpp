...
/*! This function create the bipartite graph and apply the matching between nodes
...
vector<vector<char>> MaxBipartiteGraph(int *coloring, int n_col, nodo *nodi, int nb_nodes, int nb_strg, data_matrix data,
    ...
    nodo strongNode;
    int userid, chunkid, fileid, size_strg, size_weak;
    double alpha = 0.0;
    //edges matrices
...
// othmane : run BER or CER function
// error_rate();
