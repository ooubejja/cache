...
void PC::noise_c(gr_complex * sentSymbol, gr_complex * receivedSymbol, float sqrtVariance)
{
	...
	// random_device rd;
	 ...
	 for (int i=0; i<length/2; i++)
		 receivedSymbol[i] = sentSymbol[i] + gr_complex(distribution(generator),distribution(generator));
