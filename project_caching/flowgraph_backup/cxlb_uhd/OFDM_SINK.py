...
class OFDM_SINK(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_sub_msg_source_0_0_1 = zeromq.sub_msg_source('tcp://mnode14:5559', 100)
        self.zeromq_sub_msg_source_0_0_0 = zeromq.sub_msg_source('tcp://mnode14:5560', 100)
